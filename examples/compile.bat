...
copy /Y C:\SynologyDrive\Python\create_poi\create_poi.exe                       G:\POI

copy /Y C:\SynologyDrive\Python\create_poi\create_poi.json                      C:\SynologyDrive\Python\xx_PY_on_Github\create_poi
copy /Y C:\SynologyDrive\Python\create_poi\create_poi.json                      G:\POI
...
copy /Y C:\SynologyDrive\Python\create_poi\00_make_all.cmd                      G:\POI

copy /Y C:\SynologyDrive\Python\create_poi\compile.bat                          C:\SynologyDrive\Python\xx_PY_on_Github\create_poi\examples
copy /Y C:\SynologyDrive\Python\create_poi\BMP\*.bmp                            C:\SynologyDrive\Python\xx_PY_on_Github\create_poi\bitmaps_for_moto-dealer\
copy /Y C:\SynologyDrive\Python\create_poi\BMP\*.bmp                            G:\POI\BMP\
